                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Form.Row>
                            <Form.Group as={Col}>
                                ...
                                <Form.Control name="info" type="text" placeholder="Enter Info" ref={register({ required: true })} />
                                {errors.info && <p>This field is required</p>}
                            </Form.Group>
                            <Form.Group as={Col}>
                                <Form.File id="exampleFormControlFile1" label="Service Image" onChange={handlePictureUpload} />
                            </Form.Group>
                        </Form.Row>
